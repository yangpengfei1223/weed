...
import com.hx.weed.pojo.SysRequestPathPermissionRelation;
...
@Mapper
public interface SysRequestPathPermissionRelationMapper extends IBaseDao<SysRequestPathPermissionRelation> {
    /**
     * 通过ID查询单条数据
     *
     * @param
