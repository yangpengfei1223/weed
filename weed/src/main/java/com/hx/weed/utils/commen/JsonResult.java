package com.hx.weed.utils.commen;
...
public class JsonResult<T> implements Serializable {
    ...
    public JsonResult(boolean succsess){
        this.success=success;
        this.errorCode=succsess ? ResultCode.SUCCESS.getCode() : ResultCode.COMMON_FAIL.getCode();
        this.errorMsg = succsess ? ResultCode.SUCCESS.getMessage() : ResultCode.COMMON_FAIL.getMessage();
    }
